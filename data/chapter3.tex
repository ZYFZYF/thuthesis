...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{train_time.png}
  \caption{训练时间}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{predict_time.png}
  \caption{检测时间}
  \label{fig:test:time}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{spot_time.png}
  \caption{POT方法评估时间}
  \label{fig:pot:time}
\end{figure}
...
\begin{figure}[htbp]
  \centering
  \includegraphics[width=0.8\textwidth]{best_eval_time.png}
  \caption{枚举所有阈值评估时间}
  \label{fig:eval:time}
\end{figure}
